...
public class AdminTeatroImpl implements AdminTeatroServicio{
    ...
    public AdminTeatroImpl(TeatroRepo teatroRepo, AdministradorTeatroRepo administradorTeatroRepo, HorarioRepo horarioRepo, FuncionRepo funcionRepo, SalaRepo salaRepo) {
